    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add to Gallery" class="btn-secondary">
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        //echo $ext;
                        $image_name="bag_gallery".rand(000,999).'.'.$ext;
                ...
                if($res==TRUE)
                {
                    $_SESSION['add']="<div class='success'>Added To Gallery Successfully.</div>";
                    header("location:".SITEURL.'admin/manage-gallery.php');
                }
                else
                {
                    $_SESSION['add']="<div class='error'>Failed to Add in Gallery.</div>";
                    header("location:".SITEURL.'admin/add-gallery.php');
